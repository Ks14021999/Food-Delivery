...
export const UpdateVendorProfile = async (req: Request,res: Response, next: NextFunction) => {
    ...
    const { foodType, name, address, phone, ownerName} = <EditVendorInput>req.body;
...
export const AddFood = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const { name, description, category, foodType, readyTime, price, images } = <CreateFoodInput>req.body;
